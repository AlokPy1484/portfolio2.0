...
style={{
  ...
  backgroundImage:
    ...
    <div className="flex flex-col text-4xl md:text-5xl gap-20">Selected Works


<div className="flex flex-col md:flex-row flex-wrap w-full h-full  justify-center md:items-start items-center gap-8">
