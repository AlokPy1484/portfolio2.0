        ...
        <div className="fixed flex justify-center w-full backdrop-blur-sm pt-4 pb-2 px-4 md:px-0 z-9999">
            <div className="flex justify-between items-center w-full max-w-2xl">
                ...
                <div className="flex justify-end items-center gap-2">
                    <button className="rounded-sm bg-secondary text-xs text-secondary-foreground  px-2 py-1 hover:bg-black dark:hover:bg-white cursor-pointer">Get in touch</button>
