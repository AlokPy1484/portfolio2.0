...
export default function BlogCard({heading, date, description, link}:BlogCardProps){
    ...
    return(
            ...
            <div className="flex flex-col justify-start items-start gap-2 p-4 bg-neutral-950  rounded-md w-full"
              style={{
    boxShadow:
      "0px 4px 6px -1px rgba(255, 255, 255, 0.08), 0px 2px 4px -1px rgba(255, 255, 255, 0.04)",
  }}>
