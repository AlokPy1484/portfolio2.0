...
export default function ContactCard() {
    ...
    return (
        ...
        <div
            className="p-2 ">
            <Card style={getCrossPatternBackground(theme)}
                className="w-full md:max-w-3xl border  dark:border-neutral-900 bg-neutral-100 dark:bg-neutral-950 rounded-2xl">
                <CardHeader>
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex flex-wrap gap-2 max-w-[400px]">
                            {services.map((service) => (
                                <Button className="flex  p-1 bg-neutral-100 dark:bg-neutral-900 rounded-none border border-dashed text-sm text-black hover:bg-blue-200  dark:text-white/80">{service.service}</Button>
                            ))}
                        </div>
                    </div>
                    <div>
